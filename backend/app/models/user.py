...
class ServiceRequest(db.Model):
    ...
    date_of_request = db.Column(Date, default=db.func.current_date())  # Use Date type
    date_of_completion = db.Column(Date, nullable=True) 
    service_status = db.Column(db.Enum('requested', 'assigned','accepted', 'rejected', 'closed'), nullable=False) 
